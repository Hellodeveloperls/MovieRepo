...
PICS = (environ.get('PICS', 'https://envs.sh/SWe.jpg https://envs.sh/SWt.jpg https://envs.sh/SWb.jpg')).split()
...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002014131153 -1001676068790 -1001835344717').split() if id_pattern.search(auth_channel)]
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001966906631')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001966906631')
